...
[[nodiscard]] constexpr std::string_view DescribeStatus(eStatus s) noexcept {
    switch (s) {
        ...
        case eStatus::NotOpen:            return "bus not open";
        case eStatus::BackendUnavailable: return "backend unavailable";
        case eStatus::InvalidFrame:       return "invalid frame";
        case eStatus::SequenceError:      return "ISO-TP sequence error";
        case eStatus::FlowControlAbort:   return "ISO-TP flow control abort";
        case eStatus::ChecksumError:      return "checksum error";
        case eStatus::NotInitialized:     return "client not initialized";
        case eStatus::NotSupported:       return "not supported";
        case eStatus::Overrun:            return "buffer overrun";
        case eStatus::ProtocolError:      return "protocol error";
        case eStatus::BusError:           return "bus error";
    }
    return "unknown";
}
